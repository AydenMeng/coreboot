...
#define CSR_EUEN_LBTEN         (0x1 << CSR_EUEN_LBTEN_SHIFT)
#define CSR_EUEN_LASXEN_SHIFT  2
#define CSR_EUEN_LASXEN        (0x1 << CSR_EUEN_LASXEN_SHIFT)
#define CSR_EUEN_LSXEN_SHIFT   1
#define CSR_EUEN_LSXEN         (0x1 << CSR_EUEN_LSXEN_SHIFT)
#define CSR_EUEN_FPEN_SHIFT    0
#define CSR_EUEN_FPEN          (0x1 << CSR_EUEN_FPEN_SHIFT)
...
#define CSR_ESTAT_ESUBCODE        (0x1ff << CSR_ESTAT_ESUBCODE_SHIFT)
#define CSR_ESTAT_EXC_SHIFT       16
#define CSR_ESTAT_EXC_WIDTH       6
#define CSR_ESTAT_EXC             (0x3F << CSR_ESTAT_EXC_SHIFT)
#define CSR_ESTAT_IS_SHIFT        0
#define CSR_ESTAT_IS_WIDTH        15
#define CSR_ESTAT_IS              (0x7FFF << CSR_ESTAT_IS_SHIFT)
...
#define LOONGARCH_CSR_TMCFG_EN       (1 << 0)
#define LOONGARCH_CSR_TMCFG_PERIOD   (1 << 1)
#define LOONGARCH_CSR_TMCFG_TIMEVAL  (0x3FFFFFFFFFFF << 2)
...
#define  IOCSRF_EXTIOI_DECODE     (1 << 9)
#define  IOCSRF_FLATMODE          (1 << 10)
...
#define  IOCSR_MBUF_SEND_H32_MASK   0xFFFFFFFF00000000
...
#define  IOCSR_ANY_SEND_H32_MASK    0xFFFFFFFF00000000
...
#define  IOCSR_TIMER_MASK           0x0FFFFFFFFFFFF
